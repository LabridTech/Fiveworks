    ...
    <div className="App">
      ...
      <div style={{ width : '80%' , height : isMobile() ? 300 : 200 + width * k/10 , backgroundColor : '#14111e' , paddingInline : '10%' , paddingTop : "100px"}}>
          <Typography variant="h3" sx={{color : '#FFFFFF' , marginBottom : 2}} gutterBottom>
            ...
            FiveWork is a technology solutions company specializing in web, app, and software development. We are passionate about crafting exceptional digital experiences and cutting-edge solutions tailored to your unique needs.  
            </Typography>
      </div>
